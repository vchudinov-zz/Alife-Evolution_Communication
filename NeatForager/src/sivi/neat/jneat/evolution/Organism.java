...
public class Organism extends Neat {
	 ...
	 * @param xgenome
	 *            The genome the organism is created from
	 * @param xgeneration
	 *            The generation number of the genome
	 */
	public Organism(double xfitness, Genome xgenome, int xgeneration) {
		fitness = xfitness;
		orig_fitness = xfitness;
		genome = xgenome;
		net = genome.genesis(xgenome.getGenome_id());
		species = null;
   ...
   */
	public void viewtext() {
		System.out.print("\n-ORGANISM -[genomew_id=" + genome.getGenome_id()
				+ "]");
