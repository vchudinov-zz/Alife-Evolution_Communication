...
public class NNode extends Neat {
	 ...
	 * 
	 * @param xline
	 *            The line in the genome file containing info about the node
	 * @param traits
	 *            A vector of the traits in the genome
	 */
   ...
   */
	...
	/**
	 * STC Prints out information about the node. Info printed: Type, Node ID,
	 * Number of times the node has been activated, Total activation entering
	 * the node
	 */
	public void op_view() {
		...
		System.out.print(fmtf.format(node_id) + " activation count "
				+ fmt5.format(activation_count) + " activation="
				+ fmt5.format(activation) + ")");

	}

	/**
	 * STC If node is a sensor, the activation value of the sensor is set to the
	 * value given
	 * 
	 * @param value
	 *            output value
	...
	/**
	 * STC Resets the activation counts to zero, sets the added weight to zero
	 * (after adding the weight) and sets the is_travesed flag to false.
	 */
