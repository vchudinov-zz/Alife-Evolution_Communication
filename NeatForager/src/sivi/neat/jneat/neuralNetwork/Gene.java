...
public class Gene extends Neat {
	...
	public Gene(Gene g, Trait tp, NNode inode, NNode onode) {
		lnk = new Link(tp, g.lnk.getWeight(), inode, onode,
				g.lnk.getIs_recurrent());
	 ...
	 * 
	 * @param xline
	 *            Line with the parameters for the gene
	 * @param traits
	 *            A vector of all the organisms traits
	 * @param nodes
	 *            A vector of all the organisms nodes
	 */
	...
	public void op_view() {
		...
		System.out.print("\n [Link ("
				+ fmt5.format(lnk.getIn_node().getNode_id()));
		...
		if (lnk.getLinktrait() != null)
			System.out.print(" Link's trait_id "
					+ lnk.getLinktrait().getTrait_id());
	...
	public Gene(Trait tp, double w, NNode inode, NNode onode, boolean recur,
	...
	/**
	 * Insert the method's description here. Creation date: (24/01/2002
	 * 16.59.13)
	 */
}