package sivi.neat.jneat.neuralNetwork;
...
public class Link extends Neat {
	...
	/**
	 * this is a flag; if TRUE the connection(link) is recurrent; FALSE
	 * otherwise;
	 */
	...
	/**
	 * Points to a trait of parameters for genetic creation. Is link-related
	 * parameters that change during Hebbian type learning.
	 */
	Trait linktrait;
	...
	/**
	 * Insert the method's description here. Creation date: (18/01/2002 9.16.45)
	 * 
	 * @param newIs_traversed
	 *            boolean
	 */
