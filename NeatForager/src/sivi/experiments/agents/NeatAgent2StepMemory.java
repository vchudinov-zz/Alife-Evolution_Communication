 ...
 *
 */
public abstract class NeatAgent2StepMemory extends MasterNEATAgent{
	double previousMove,twoStepsBeforeMove;
	int action;
	boolean previousLamp, twoStepsBeforeLamp;
	
	public NeatAgent2StepMemory(int id, ENTITYCOLOR color, int startEnergy, Organism org, SCANNER_TYPE scannerType) {
